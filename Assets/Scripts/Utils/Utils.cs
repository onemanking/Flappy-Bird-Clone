...
{
    internal static bool IsReachedBoundaryY(float y, bool checkBottomScreen)
    {
        var cam = Camera.main;
        ...
        return checkBottomScreen ? y < screenBottom : y > screenTop;
    }
    ...
    internal static bool IsReachedBoundaryX(float x, bool checkLeftScreen)
    {
        var cam = Camera.main;
        ...
        return checkLeftScreen ? x < screenLeft : x > screenRight;
    }
